...
<body class="body" style="background-color: #DAEAF2; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #daeaf2;">
    <tbody>
    <tr>
        <td>
                                ...
                                <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                    <table class="image_block block-1" width="100%" border="0" cellpadding="15" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <div class="fullWidth" style="max-width: 374px;"><img src="https://imagenes-ibae.s3.us-east-2.amazonaws.com/images/logos/candado.png" style="display: block; height: auto; border: 0; width: 100%;" width="374" alt="Resetting Password" title="Resetting Password" height="auto"></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="heading_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad" style="text-align:center;width:100%;">
                                                <h1 style="margin: 0; color: #5a2d82; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 32px; font-weight: bold; letter-spacing: normal; line-height: 1.2; text-align: center; background-color: #f3e5f5; padding: 10px; border-radius: 8px;">
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
                                                <div style="color:#848484;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:180%;text-align:center;mso-line-height-alt:25.2px;">
                                                    <p style="margin: 0;">Estas son tus credencial para iniciar sesion en ibae<br><p style="font-size: 16px; color: #666;">Usuario: <strong style="background-color: #f3e5f5; padding: 5px; border-radius: 5px;">{{ $usuario->username }}</strong></p>
                                                    <p style="font-size: 16px; color: #666;">Contraseña: <strong style="background-color: #f3e5f5; padding: 5px; border-radius: 5px;">{{ $password }}</strong></p></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
