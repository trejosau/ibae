                        ...
                        <div class="col-12 col-lg-5">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control border-0 border-bottom rounded-0" name="email" id="email" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border-0 border-bottom rounded-0" name="password_confirmation" id="password_confirmation" required>
